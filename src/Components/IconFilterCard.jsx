...
function IconFilterCard(props) {
    ...
    const {filterName, filterImage} = props;

    return (
        <div className='ml-2 pl-[2px] snap-start relative max-w-full p-0'> 
            <div>
                <div className='flex items-center justify-center flex-col gap-1 cursor-pointer p-1 rounded-2xl w-auto whitespace-nowrap'>
