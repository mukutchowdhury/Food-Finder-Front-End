            ...
            <div className='max-w-full'>
                <div className='max-w-full flex justify-start'>
                    <div className='max-w-full px-4 py-4'>
                        <div className='w-56 h-56 border-[10px] rounded-2xl border-black'>
                            {pimage === 'null' ? (
                                <div className="w-full h-full flex items-center justify-center bg-gray-300">
                                    <FontAwesomeIcon icon={faUser} />
                                </div>
                            ) : (
                                <div className="w-full h-full flex bg-tr bg-cover bg-center bg-no-repeat" style={{backgroundImage: `url(${pimage})`}}></div>
                            )}
                        </div>
